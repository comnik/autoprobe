...
REMEMBER: The `$HOPPER_PROGRAMS_DIR` directory is the only persistent memory have, so you should write
...
The solution program should also be written to the `$HOPPER_PROGRAMS_DIR` directory.
