...
REMEMBER: The `programs/` directory is the only persistent memory have, so you should write
...
The solution program should also be written to the `programs/` directory.
